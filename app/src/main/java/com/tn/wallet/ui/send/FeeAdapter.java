...
import com.tn.wallet.databinding.ItemAssetAccountBinding;
...
public class FeeAdapter extends ArrayAdapter<FeeItem> {
    ...
    public static List<FeeItem> getPredefinedFees(Context context) {
        return Arrays.asList(
                new FeeItem(context.getString(R.string.fee_economic), 2000000L),
                new FeeItem(context.getString(R.string.fee_standard), 2500000L),
                new FeeItem(context.getString(R.string.fee_premium),  3000000L));
    }
