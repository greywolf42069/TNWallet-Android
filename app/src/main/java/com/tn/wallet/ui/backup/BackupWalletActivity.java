package com.tn.wallet.ui.backup;
...
public class BackupWalletActivity extends BaseAuthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isBackedUp()) {
            startFragment(com.tn.wallet.ui.backup.BackupWalletCompletedFragment.newInstance(false), com.tn.wallet.ui.backup.BackupWalletCompletedFragment.TAG);
        } else {
            startFragment(new com.tn.wallet.ui.backup.BackupWalletStartingFragment(), BackupWalletStartingFragment.TAG);
        }
    }
