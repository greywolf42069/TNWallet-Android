...
import com.tn.wallet.databinding.ActivityPasswordWalletBinding;
import com.tn.wallet.ui.base.BaseAuthActivity;
import com.tn.wallet.ui.customviews.ToastCustom;
import com.tn.wallet.util.PasswordUtil;
import com.tn.wallet.util.annotations.Thunk;

import static com.tn.wallet.ui.auth.PinEntryViewModel.KEY_INTENT_CREATE_NEW_PIN;
...
public class PasswordWalletActivity extends BaseAuthActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.commandNext.setOnClickListener(v -> {
            ...
            if (!com.tn.wallet.util.StringUtils.isValidName(em)) {
