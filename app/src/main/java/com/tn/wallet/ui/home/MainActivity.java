...
import com.tn.wallet.BuildConfig;
import com.tn.wallet.R;
import com.tn.wallet.api.NodeManager;
import com.tn.wallet.data.access.AccessState;
import com.tn.wallet.databinding.ActivityMainBinding;
import com.tn.wallet.ui.assets.AssetsActivity;
...
public class MainActivity extends BaseAuthActivity implements TransactionsFragment.Communicator,
    ...
    private static final String SUPPORT_EMAIL = "support@blackturtle.eu";
